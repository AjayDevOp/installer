...
replace (
	...
	github.com/openshift/machine-config-operator => github.com/openshift/machine-config-operator v0.0.1-0.20200405051300-671a5546fd34 // Pin MCO so it doesn't get downgraded
